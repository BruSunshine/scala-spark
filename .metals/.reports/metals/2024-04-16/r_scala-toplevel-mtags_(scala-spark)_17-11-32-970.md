...
")
jar:file://<HOME>/.cache/coursier/v1/https/repo1.maven.org/maven2/org/json4s/json4s-ast_2.13/3.7.0-M11/json4s-ast_2.13-3.7.0-M11-sources.jar!/org/json4s/JsonAST.scala
jar:file://<HOME>/.cache/coursier/v1/https/repo1.maven.org/maven2/org/json4s/json4s-ast_2.13/3.7.0-M11/json4s-ast_2.13-3.7.0-M11-sources.jar!/org/json4s/JsonAST.scala:112: error: expected identifier; obtained def
    def values = None
    ^
#### Short summary: 
